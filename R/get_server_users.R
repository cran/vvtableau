...
#' @importFrom magrittr %>%
#'
#' @return Dataframe containing information on users on the server.
#' @export
#'
#' @family tableau rest api
get_server_users <- function(base_url, api_version = 3.4, site_id, token, page_size = 100, include_metadata = FALSE) {
